...
public class ILRepack : Microsoft.Build.Utilities.Task, IDisposable
{
  ...
  /// <summary>
  ///   Log level for ILRepack (Trace, Debug, Information, Warning, Error, Critical).
  /// </summary>
  ...
  public override bool Execute()
  {
    ...
    {
      logger.LogLevel = (LogLevel)Enum.Parse(typeof(LogLevel), LogLevel);
    }
    ...
    {
      logger.Log(e, Microsoft.Extensions.Logging.LogLevel.Error);
      logger.Close();
