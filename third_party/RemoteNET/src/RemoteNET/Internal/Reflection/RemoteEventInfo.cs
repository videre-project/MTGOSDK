...
namespace RemoteNET.Internal.Reflection
{
  public class RemoteEventInfo : EventInfo
  {
    ...
    public RemoteEventInfo(
      ...
      string name) : this(declaringType, new Lazy<Type>(() => eventHandlerType), name)
    {}

    public RemoteEventInfo(
      RemoteType declaringType,
      EventInfo ei) : this(declaringType, new Lazy<Type>(() => ei.EventHandlerType), ei.Name)
    {}
    ...
    public override string ToString() => $"{_eventHandlerType.Value} {Name}";
  }
}
